...
- 运行时配置继续放在树莓派实际路径，例如 `/home/pi/apps/home-stack/docker-compose.yml`、`/home/pi/apps/home-stack/ha/config`。
...
- 生成 Pi 本地备份包：`/home/pi/apps/infra-backup/local-backups/pi/pi-infra-backup-2026-05-10-032548.tar.gz`
- 生成备份日志：`/home/pi/apps/infra-backup/logs/pi-local-backup-2026-05-10-032548.log`
- 生成恢复验证日志：`/home/pi/apps/infra-backup/logs/restore-test-2026-05-10-032614.log`
...
- `/home/pi/apps/home-stack/docker-compose.yml`
- `/home/pi/apps/home-stack/.env`
...
- `/home/pi/.cloudflared`
- `/home/pi/apps/home-stack/filebrowser/config`
- `/home/pi/apps/home-stack/filebrowser/database`
- `/home/pi/apps/home-stack/uptime-kuma/db-config.json`
- `/home/pi/apps/home-stack/uptime-kuma/kuma.db`
...
- `/home/pi/apps/home-stack/ha/Dockerfile.ha`
- `/home/pi/apps/home-stack/ha/config/configuration.yaml`
- `/home/pi/apps/home-stack/ha/config/secrets.yaml`
- `/home/pi/apps/home-stack/ha/config/automations.yaml`
- `/home/pi/apps/home-stack/ha/config/scripts.yaml`
- `/home/pi/apps/home-stack/ha/config/scenes.yaml`
- `/home/pi/apps/home-stack/ha/config/backups`

Home Assistant 的 YAML、密钥、自动化、脚本、场景都属于恢复核心。`backups` 目录也要保留，因为它能帮助从 HA 自己的备份中恢复集成和状态。

### Mosquitto

- `/home/pi/apps/home-stack/mosquitto/config`
- `/home/pi/apps/home-stack/mosquitto/data`

MQTT broker 的配置和持久数据需要备份，否则 Zigbee2MQTT、HA 和其它 MQTT 客户端恢复后可能连不上或状态丢失。

### Zigbee2MQTT

- `/home/pi/apps/home-stack/zigbee2mqtt/data/configuration.yaml`
- `/home/pi/apps/home-stack/zigbee2mqtt/data/coordinator_backup.json`
- `/home/pi/apps/home-stack/zigbee2mqtt/data/database.db`
- `/home/pi/apps/home-stack/zigbee2mqtt/data/state.json`
- `/home/pi/apps/home-stack/zigbee2mqtt/data/external_converters`
...
- `/home/pi/apps/home-stack/caddy/Caddyfile`
...
当前树莓派主服务栈运行目录是 `/home/pi/apps/home-stack`。
