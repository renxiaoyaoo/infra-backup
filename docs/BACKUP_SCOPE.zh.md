...
- `$HOME/network/mihomo/config.yaml`
- `$HOME/network/mihomo/proxies`
- `$HOME/network/mihomo/rules`
...
- mihomo 下载数据、缓存和 Web UI：`Country.mmdb`、`GeoIP.dat`、`GeoSite.dat`、`cache.db`、`geoip.metadb`、`ui`
